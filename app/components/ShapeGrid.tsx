...
const ShapeGrid = ({
  ...
  useEffect(() => {
    ...
    const updateAnimation = () => {
      ...
      if (direction === 'right') gridOffset.current.x = (gridOffset.current.x - s + wrapX) % wrapX;
      else if (direction === 'left') gridOffset.current.x = (gridOffset.current.x + s + wrapX) % wrapX;
      else if (direction === 'up') gridOffset.current.y = (gridOffset.current.y + s + wrapY) % wrapY;
      else if (direction === 'down') gridOffset.current.y = (gridOffset.current.y - s + wrapY) % wrapY;
      else if (direction === 'diagonal') {
        gridOffset.current.x = (gridOffset.current.x - s + wrapX) % wrapX;
        gridOffset.current.y = (gridOffset.current.y - s + wrapY) % wrapY;
      }
      updateCellOpacities();
      drawGrid();
